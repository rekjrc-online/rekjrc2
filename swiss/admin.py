...
@admin.register(SwissRace)
class SwissRaceAdmin(admin.ModelAdmin):
    list_display = ('round_number', 'race_display', 'model1_display', 'model2_display', 'winner_display')
    search_fields = (
        'race__display_name',
    ...
    list_filter = ('race',)
    ordering    = ('race__created_at', 'round_number', 'id')
