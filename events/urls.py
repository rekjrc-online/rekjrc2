...
urlpatterns = [
    ...
    path("<uuid:uuid>/checkin/", views.Checkin_.as_view(), name="checkin"),
    path("<uuid:uuid>/checkin/rfid-poll/", views.CheckinRfidPoll_.as_view(), name="checkin-rfid-poll"),
    path("<uuid:uuid>/checkin/<int:checkin_id>/remove/", views.CheckinRemove.as_view(), name="checkin-remove"),
