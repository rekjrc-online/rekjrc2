...
class ChatMessageModelTests(TestCase):
    ...
    def test_chat_message_creation(self):
        msg = ChatMessage.objects.create(
            user=self.user,
            speaker_content_type=ContentType.objects.get_for_model(self.speaker),
            speaker_object_id=self.speaker.pk,
        ...
        self.assertEqual(msg.speaker, self.speaker)
...
class ChatMessageFormTests(TestCase):
    ...
    def test_form_invalid_without_speaker(self):
        form = ChatMessageForm(
            data={"content": "Hello"},
            user=self.user,
            channel=self.channel)
